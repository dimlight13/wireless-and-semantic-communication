export const metadata = {
  title: "QAM Demodulation and LLR Calculation",
};
  ...
  function render() {
    ...
    root.innerHTML = `
      ...
      <div class="vis-panel demod-demo">
        <section>
          <h2>16-QAM Demodulation: Received Symbol → LLR</h2>
          <p class="hint">For received symbol y on the constellation, the demodulator computes an LLR for each bit's likelihood of being 0 or 1. LLR = (nearest-0 distance − nearest-1 distance) / σ². Drag the plot to move the received symbol.</p>
        </section>
          ...
          <div class="demod-grid">
            ...
            <div>
              ...
              <div class="demod-note">
                Nearest symbol: <b style="color:#c86414">${points[closest].bits}</b><br>
                Hard-decision result: <b>${hard.join("")}</b><br>
                The closer an LLR is to 0, the more uncertain the bit is. The LDPC decoder uses this soft information to correct errors.
              </div>
            </div>
          </div>
        </section>
